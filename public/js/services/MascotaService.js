...
async function RegistrarMascota( pNombre, pEspecie, pEstrellas,pObservaciones,pFotoMascota,pIdPersona) {
    let result = {};
    await axios({
        method: 'post',
...
async function ModificarMascota( pNombre, pEspecie, pEstrellas,pObservaciones,pFotoMascota,pIdPersona) {
    let result = {};
    await axios({
        method: 'post',
