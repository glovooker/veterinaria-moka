...
let perfilSecretaria = 'avelasquez';/* aca colocamos el nombre del usuario tipo veterinario que queramos buscar*/

ImprimirInformacion();

function ImprimirInformacion(){
    let DatosCliente = obtenerDatos(perfilSecretaria);
