...
async function desplegarDatosConsultados() {
  ...
  if (mascotaConsultada != null) {
    ...
    document.getElementById('txtDueñoMascota').value = owner.Nombre;
    document.getElementById('txtUsuario').value = owner.Usuario;
    document.getElementById('txtCedula').value = owner.Cedula;
    document.getElementById('txtDireccion').value = owner.Direccion;
    document.getElementById('txtTelefono').value = owner.Telefono;
    document.getElementById('txtEmail').value = owner.Correo;
